...
const projects = [
  {
    ...
    description: "MERN stack project with real-time code execution and multi-language support (C, C++, JS, Bash, etc.). Includes a user-friendly web-based editor accessible across devices with scalability and performance optimizations.",
    image: "/assets/project1.png",
    link: "https://github.com/Mahendra111111/Online-Code-Editor.git"
  },
  {
    id: 2,
    title: "Uber Clone",
