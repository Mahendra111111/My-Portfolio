...
• Gained hands-on experience with modern tools and platforms including React.js, Next.js, Supabase, Shopify, WordPress, n8n, and cloud services`,
    ...
    },
    {
      ...
      description: `
• Developed dynamic and responsive web applications using the MERN stack  
• Designed seamless interfaces with interactive features and optimized performance  
• Collaborated in an agile team to solve real-world problems under strict deadlines  
        ...
        <div className="px-5 lg:px-28 my-8 lg:mt-16 space-y-10">
          {experiences.map((exp, index) => (
            ...
            >
              ...
              <p className="text-[#D4D4D8] mt-6 text-sm/6 lg:text-base font-light whitespace-pre-line">
                {exp.description}
              </p>
            </motion.div>
          ))}
